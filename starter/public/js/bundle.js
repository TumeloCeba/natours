...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidHVtZWxvY2ViYSIsImEiOiJja3owbmhobnQwODVjMm90MjM4NWRmbWNpIn0.oyGE-ofSzKz2u_YEtuu-pg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/mapbox/streets-v11',
    scrollZoon: false //center: ,
    //zoom: 10,
    //interactive: false
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (result.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged out successfully'); //the true makes it reload from the server
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (response.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " Updated successfully")); //the true makes it reload from the server
              //location.reload(true);
            }
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            stripe = Stripe('pk_test_51KXZH0DH1JRyagpEzkKAEShB87NLvOVBu9WbGSyQmbLtAkxsRH8ql1gNVk3FZtItsGvtEr0BwMxiWchiSLS6xR4V00bBo72eQS'); // 1) Get checkout session from API
          ...
          case 9:
            ...
            (0, _alerts.showAlert)(_context.t0, _context.t0);
